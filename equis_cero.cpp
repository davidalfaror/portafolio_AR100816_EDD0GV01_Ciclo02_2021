...
int main() {
	char jugarDeNuevo;
	srand(time(0)); // Inicializar la semilla de los números aleatorios
	do{
		jugar();
...
void jugar(){
	...
	cout << "Juego de equis-cero     Alumno: David Alfaro AR100816" <<endl;
...
int leerNumero(string indicacion, string mensajeError, int min, int max){
	...
	while (!(cin >> numero) || (numero < min || numero >max)){
		cin.clear(); // limpía la entrada estandar

...
"Tretis", "The Elder Scrolls", "The Legend of Zelda",
...
// Inicializa la palabra del jugador con guines bajos
...
// y la devuelve a la funcion  desde donde se invoca
char pedirLetra(char respuesta)

// Valida si la letra ingresada e sparte de la palabra
...
//Elige al azar uno de los elementos del arreglo
string elegirElemento(array<string, SIZE> &arr) {
	//variable est[atica, "recuerda" su valor
	...
	// Genera un numero aleatorio entre 0 y 24
...
char pedirLetra(char respuesta[]) {
	// Escriba una funcion que lea una letra y la devuelva a la funcion main	
}
...
int busquedaBinaria(array<string, SIZE> &arr, string valor) {
	//Implemente la funci[on busqueda binaria, para devolver el indice en el que se encuentra el valor o -1 si este no existe en el arreglo
}
